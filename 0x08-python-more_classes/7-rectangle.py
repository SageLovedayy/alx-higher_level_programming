...
class Rectangle():
    ...
    Methods:
        ...
        __del__(self): Deletes the instance of the rectangle and
        decrements the count of instances.
    ...
    def __del__(self):
        """
        Deletes the instance of the rectangle and decrements
    ...
    def __str__(self):
        ...
        Returns:
            str: A string representing the rectangle with the
            specified print symbol.
        """
        if self.__width == 0 or self.__height == 0:
            return ""
